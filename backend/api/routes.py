"""
FastAPI routes for CBQA V6 — AI Repository Intelligence Platform.
...
app = FastAPI(title="CBQA V6", description="AI Repository Intelligence Platform", version="6.0.0")
...
def health():
    ...
    return HealthResponse(
        ...
        llm_provider=settings.LLM_PROVIDER, llm_model=model,
